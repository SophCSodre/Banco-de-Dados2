...
INSERT INTO Veiculos (IDVeiculo, Fabricante, Modelo, Ano, Preco)
...
SELECT IDVeiculo, Modelo, Ano FROM Veiculos;

SELECT * FROM Veiculos ORDER BY Modelo ASC;

SELECT * FROM Veiculos ORDER BY Preco DESC;

SELECT Modelo, Ano, Preco FROM Veiculos ORDER BY Fabricante ASC;
